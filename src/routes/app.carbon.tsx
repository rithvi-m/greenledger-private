  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <Kpi label="Total tCO₂e" value={formatTco2e(total)} sub="Scope 1 + Scope 2" empty={!hasVerified} />

        <Kpi label="Scope 2 (grid)" value={formatTco2e(scope2)} sub={`CEA ${CEA_GRID_FACTOR} kg/kWh`} empty={!hasVerified} />

        <Kpi label="Scope 1 (diesel)" value={formatTco2e(scope1)} sub="Generator fuel invoices" empty={!hasVerified} />

        <Kpi label="CBAM exposure" value={formatInrLakhs(cbam)} sub="Est. if uncertified export" empty={!hasVerified} accent />
        ...
        <div className="gl-console-card p-5">
          ...
          <ul className="mt-4 space-y-3 text-sm">
            ...
            {[
              ...
              { text: "Embedded emissions calculated per ISO 14064", ok: hasVerified },

              { text: "CEA grid factor cited for Scope 2", ok: hasVerified },

              { text: "Human-verified source bills on file", ok: hasVerified },

              { text: "Certificate draft available for export", ok: hasVerified },
